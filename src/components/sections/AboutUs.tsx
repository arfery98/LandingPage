...
export const AboutUs = () => {
    return (
        <section id="about-us">
            <Container className="flex flex-col md:flex-row lg:gap-12 items-center gap-4">
                <div className="w-full md:w-5/12 lg:w-1/2">
                    <div className="w-full h-82 sm:h-96 relative">
                ...
                <div className="w-full md:w-7/12 lg:w-1/2 flex flex-col">
                    ...
                    <div className="pt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
                        ...
                        <Info title="vision" description="Our mission is to use AI for the good of humanity and the planet.">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="30"
                                fill="none"
